...
import (
	...
	cliproxycmd "github.com/router-for-me/CLIProxyAPI/v6/internal/cmd"
...
type commandExecutor struct {
	setup  func(*config.Config, *SetupOptions)
...
func runSetup(
	...
	if jsonOutput {
		capturedStdout, capturedStderr, runErr := captureStdIO(func() error {
			exec.setup(cfg, &SetupOptions{ConfigPath: configPath})
			return nil
		})
