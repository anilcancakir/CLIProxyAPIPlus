...
func TestResponsesToOpenAI_PassesBuiltinWebSearchTool(t *testing.T) {
	// Skipped: web_search_preview pass-through not implemented in this fork's translator.
	t.Skip("web_search_preview pass-through not available in this fork")
}

// --- OpenAI→Claude response tests ---

func TestOpenAIToClaude_StreamAnnotationsAsCitations(t *testing.T) {
	// Skipped: annotation→citation conversion not implemented in this fork's translator.
	t.Skip("annotation-to-citation conversion not available in this fork")
...
func TestOpenAIToGemini_StreamAnnotationsAsGroundingMetadata(t *testing.T) {
	// Skipped: annotation→groundingMetadata conversion not implemented in this fork's translator.
	t.Skip("annotation-to-groundingMetadata conversion not available in this fork")
	ctx := context.Background()
	model := "gpt-4o"
	reqJSON := []byte(`{}`)
	var param any
...
func TestOpenAIToResponses_StreamAnnotationsPopulated(t *testing.T) {
	// Skipped: annotation population in Responses format not implemented in this fork's translator.
	t.Skip("annotation population in Responses format not available in this fork")
	ctx := context.Background()
	model := "gpt-4o"
	reqJSON := []byte(`{}`)
	var param any
